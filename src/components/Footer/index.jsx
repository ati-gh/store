export default function Footer() {
  return (
    <>
      {/* <div className="h-20 w-full md:hidden border-t border-t-[#626262] fixed bottom-0  items-center p-6 flex justify-between ">
        <div>
          <svg
        ...
        <div className="relative">
          <p className="absolute bottom-6 p-0.5 left-8 bg-cyan-400 rounded-full"></p>
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32px"
      ...
      <div className=" hidden md:block w-full mt-8 border-t border-t-[#626262]  h-fit">
        <div className="flex justify-between w-full ">
          <ul className="text-[#626262]">
          ...
          <ul className="text-[#626262]">
            <li>Contact Number: +98 930 040 0642</li>
            <li>Githab: ati-gh</li>
          </ul>
        </div>
      </div>
